...
namespace TaskKevin.Migrations
{
    ...
    [Migration("20230202174758_1To1BetweenUserAndRole")]
    partial class _1To1BetweenUserAndRole
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskKevin.Data.Model.Roles", b =>
                {
                    b.HasOne("TaskKevin.Data.Model.User", "User")
                        .WithOne("rolesLink")
                        .HasForeignKey("TaskKevin.Data.Model.Roles", "userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
